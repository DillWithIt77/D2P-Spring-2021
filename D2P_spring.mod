...
var c_pos{POS_LEAF_NODES, 1..SAMPLES_POS} >= 0, <= 1, binary; # =1 if correctly classified
var c_neg{NEG_LEAF_NODES, 1..SAMPLES_NEG} >= 0, <= 1, binary; # =1 if correctly classified
